...
class _CheckPassStatusState extends State<CheckPassStatus> {
  ...
  final imageUrl = "http://13.234.208.246api/auth/new_transit_pass_pdf/90/";
  ...
  final List sr4 = [];
  final List App_no4 = [];
  final List App_Date4 = [];

  List list4 = [];
  Map<String, dynamic> responseJSON4;
  int allApplication4 = 0;
  void updateLoc() async {
    ...
    App_Date4.clear();
    print("hello");
    const String url = 'http://13.234.208.246/api/auth/ListAddImageApplication';
    ...
    List list4 = responseJSON["data"];

    setState(() {
      allApplication4 = list4.length;
    });
    for (var i = 0; i < allApplication4; i++) {
      sr4.add((i).toString());
      Ids4.add(list4[i]['id'].toString());
      App_no4.add(list4[i]['application_no']);
      App_Date4.add(list4[i]['created_date'].toString());
    }
  }
  ...
  void check_pass() async {
    ...
    //-----clear------
    print("hello");
    const String url = 'http://13.234.208.246/api/auth/ListViewApplication';
  ...
  String OfficerStatus(
    ...
    if (division == true) {
      if (AppStatus == 'R') {
        ...
        return "Recomented by Division Officer";
      }
    } else if (forest == true) {
      if (otherState == false) {
        if (AppStatus == 'R') {
          ...
          return "Recomented by Forest Range Officer";
        }
      } else {
        if (AppStatus == 'R') {
          return "Rejected By Forest Range Officer";
      ...
      if (AppStatus == 'R') {
        ...
        return "Revenue Officer Recommendation Pending";
      }
    }
  }
                              ...
                              child: Scrollbar(
                                  ...
                                  child: SingleChildScrollView(
                                      ...
                                      child: DataTable(
                                        ...
                                        rows:
                                            sr4 // Loops through dataColumnText, each iteration assigning the value to element
                                                .map(
                                                  ((value) => DataRow(
                                                        cells: <DataCell>[
                                                          DataCell((Text((int
                                                        ...
                                                        cells: <DataCell>[
                                                          ...
                                                          DataCell(Text(App_Date[
                                                                  int.parse(
                                                                      value)]
                                                              .toString())),
                                                          DataCell(Text(App_Status[
                                                                          int.parse(
                                                                              value)]
                                                                      .toString() ==
                                                                  'A'
                                                              ? "Approved"
                                                              : App_Status[int.parse(
                                                                              value)]
                                                                          .toString() ==
                                                                      'S'
                                                                  ? "Submitted"
                                                          ...
                                                          DataCell(
                                                            IconButton(
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                await launch(
                                                                    "http://13.234.208.246api/auth/new_noc_pdf/" +
                                                                        Ids3[int.parse(
                                                                            value)] +
                                                                        "/");
                                                                // _requestDownload("http://www.orimi.com/pdf-test.pdf");
