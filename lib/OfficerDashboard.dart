                                                    ...
                                                    DataCell(Text(AssignOfficer(
                                                        ...
                                                        : AssignOfficer(
                                                                ...
                                                                assigned_deputy1_by_id[
                                                                    int.parse(
                                                                        value)],
                                                                log_updated_by_use[int.parse(value)])
                                                            .toString())),
                                                    ...
                                                    DataCell(
                                                      Visibility(
                                                        child: IconButton(
                                                          ...
                                                          onPressed: () async {
                                                            await launch(
                                                                "http://13.234.208.246/app/location_views/" +
                                                                    Ids[int.parse(
                                                                        value)] +
                                                                    "/");
                                                            // _requestDownload("http://www.orimi.com/pdf-test.pdf");
                                                      ...
                                                      cells: <DataCell>[
                                                        ...
                                                        DataCell(
                                                          IconButton(
                                                            ...
                                                            // onPressed: ()async{
                                                            //   await launch(" http://13.234.208.246api/auth/new_noc_pdf/"+Ids3[int.parse(value)]+"/");
                                                            //   // _requestDownload("http://www.orimi.com/pdf-test.pdf");
                                                            // },
                                                          ),
                                                        ),
