...
class tigramWoodShedState extends State<tigramWoodShed> {
  ...
  void view_sellerAdded() async {
    ...
    disti.clear();
    status.clear();
    const String url = 'http://13.234.208.246api/auth/Buyer_Seller_Add_Data';
  ...
  void view_AllAdded() async {
    ...
    dist1.clear();
    const String url =
        'http://13.234.208.246api/auth/View_All_BuyerRequirement';
  ...
  void view_buyerselect() async {
    ...
    disti2.clear();
    status2.clear();
    const String url = 'http://13.234.208.246api/auth/SellerView_SelectedDta';
